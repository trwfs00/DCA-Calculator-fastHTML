...
def get():
    return Html(
        Head(
            ...
            Meta(name="description", content="DCA Calculator for calculating Dollar-Cost Averaging investments."),
            Meta(name="keywords", content="DCA, Dollar-Cost Averaging, Investment Calculator, Stocks"),
            ...
            ''', _ctype='text/javascript', defer=True),
        ),
        Body(
            Div(
                Div(
...
async def calculate(request):
    ...
    <h1>{formatted_value} {currency}</h1>
